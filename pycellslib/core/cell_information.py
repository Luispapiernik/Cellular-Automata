...
class CellInformation(metaclass=ABCMeta):
    ...
    def get_default_state(self) -> int:
        ...
        -------
        out: int
            valor del estado por defecto de la celula
        """

    @abstractmethod
    def get_default_value_of_attributes(
        self,
    ) -> Union[list, npt.NDArray[np.float], None]:
        """
    ...
    def get_state_name(self, state: int) -> str:
        ...
        ----------
        state: int
            valor del estado del que se desea conocer el nombre

        Returns
        -------
        out: str
            nombre del estado, puede ser un string vacio
        """
    ...
    def get_attribute_name(self, index: int) -> str:
        ...
        ----------
        index: int
            indice que corresponde al atributo

        Returns
        -------
        out: str
            nombre del atributo, puede ser un string vacio
        """
